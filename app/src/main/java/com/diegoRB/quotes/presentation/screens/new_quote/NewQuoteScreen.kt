...
import com.diegoRB.quotes.presentation.screens.new_quote.components.NewQuote
import com.diegoRB.quotes.presentation.screens.new_quote.components.NewQuoteContent
import com.diegoRB.quotes.presentation.ui.theme.Red900
import com.diegoRB.quotes.presentation.ui.theme.White50

@SuppressLint("UnusedMaterialScaffoldPaddingParameter")
@Composable
fun NewQuoteScreen(navController: NavHostController, viewModel: NewQuoteViewModel = hiltViewModel()) {
    Scaffold(
        topBar = {
                 DefaultTopBar(
                     title = "",

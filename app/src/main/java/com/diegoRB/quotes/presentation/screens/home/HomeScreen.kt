package com.diegoRB.quotes.presentation.screens.home
...
fun BottomBar(navController: NavHostController){
    val screens = listOf( //Pantallas a las que navegaremos
        HomeBottomBarScreen.Quotes,
        HomeBottomBarScreen.MyQuotes,
